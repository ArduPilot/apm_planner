...
{
    int x1 = qRound(xMap.xTransform(rect.left()));
    int x2 = qRound(xMap.xTransform(rect.right()));
    int y1 = qRound(yMap.xTransform(rect.top()));
    int y2 = qRound(yMap.xTransform(rect.bottom()));
