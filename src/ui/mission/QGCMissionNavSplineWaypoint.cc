#include "QGCMissionNavSplineWaypoint.h"
#include "ui_QGCMissionNavSplineWaypoint.h"
#include "WaypointEditableView.h"

QGCMissionNavSplineWaypoint::QGCMissionNavSplineWaypoint(WaypointEditableView* WEV) :
    QWidget(WEV),
    ui(new Ui::QGCMissionNavSplineWaypoint)
    {
        ui->setupUi(this);
        this->WEV = WEV;
...
void QGCMissionNavSplineWaypoint::updateFrame(MAV_FRAME frame)
{
    switch(frame)
    {
...
QGCMissionNavSplineWaypoint::~QGCMissionNavSplineWaypoint()
{
    delete ui;
}
