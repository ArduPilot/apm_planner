...
public:
    ...
    struct dataType
    {
        ...
        int m_maxIndex{};               /// If it's an indexed datatype this is the max index otherwise 0
        int m_indexFieldIndex{-1};      /// If it's an indexed datatype this points the field where the index is stored. -1 means not indexed.
