...
New_MAVLinkDecoder::New_MAVLinkDecoder(QObject *parent) : QObject(parent)
{
...
void New_MAVLinkDecoder::sendMessage(mavlink_message_t msg)
{

}
void New_MAVLinkDecoder::messageReceived(LinkInterface* link, mavlink_message_t message)
{
    Q_UNUSED(link);
...
void New_MAVLinkDecoder::emitFieldValue(mavlink_message_t* msg, int fieldid, quint64 time)
{
...
quint64 New_MAVLinkDecoder::getUnixTimeFromMs(int systemID, quint64 time)
{
    quint64 ret = 0;
    if (time == 0)
    {
