        ...
        for (int i=0;i<bytes.size();i++)
        {
            ...
            if (decodeState != 1)
            {
                ...
                if (timebuf.size() == 8)
                {
                    ...
                    unsigned long logmsecs = static_cast<unsigned long>(timebuf.at(0)) << 56;
                    logmsecs += static_cast<unsigned long>(timebuf.at(1)) << 48;
                    logmsecs += static_cast<unsigned long>(timebuf.at(2)) << 40;
                    logmsecs += static_cast<unsigned long>(timebuf.at(3)) << 32;
                    logmsecs += static_cast<unsigned long>(timebuf.at(4)) << 24;
                    logmsecs += static_cast<unsigned long>(timebuf.at(5)) << 16;
                    logmsecs += static_cast<unsigned long>(timebuf.at(6)) << 8;
                    logmsecs += static_cast<unsigned long>(timebuf.at(7)) << 0;
