...
WindowsBuild {
    ...
    for(COPY_DIR, COPY_DIRECTORY_LIST):QMAKE_POST_LINK += $$CONCATCMD $$QMAKE_COPY_DIR $$BASEDIR_COPY\\$${COPY_DIR} $$DESTDIR_COPY_RESOURCE_LIST\\$$COPY_DIR
}
...
LinuxBuild {
    ...
    for(COPY_DIR, COPY_DIRECTORY_LIST):QMAKE_POST_LINK += $$CONCATCMD $$QMAKE_COPY_DIR $$BASEDIR/$${COPY_DIR} $$DESTDIR_COPY_RESOURCE_LIST
}
